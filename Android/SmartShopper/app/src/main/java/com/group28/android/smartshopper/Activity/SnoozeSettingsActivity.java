 ...
 */
public class SnoozeSettingsActivity extends AppCompatPreferenceActivity {
    /**
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            ...
            if (id == android.R.id.home) {
                startActivity(new Intent(getActivity(), SnoozeSettingsActivity.class));
                return true;
            }
    ...
    public static class NotificationPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
           ...
           // bindPreferenceSummaryToValue(findPreference("snooze"));


            SwitchPreference vibrateSwitch = (SwitchPreference) findPreference("snooze");
